...
Common variables:
  ...
  CODEX_AUDIT_TIMEOUT_SECONDS=900
...
codex_audit_timeout_seconds: ${CODEX_AUDIT_TIMEOUT_SECONDS:-900}
...
configure_codex_env() {
  ...
  export CODEX_AUDIT_TIMEOUT_SECONDS="${CODEX_AUDIT_TIMEOUT_SECONDS:-900}"
