...
- package_id: codex-ptr-41847e97-96d8-4371-80c5-66a1a377891c-batch-0
...
### Target ptr_review:41847e97-96d8-4371-80c5-66a1a377891c:PTR_TABLE:2.2.2:table-6:missing
{"allowed_evidence_refs": ["finding:41847e97-96d8-4371-80c5-66a1a377891c:PTR_TABLE:2.2.2:table-6:missing", "rule_context:41847e97-96d8-4371-80c5-66a1a377891c:PTR_TABLE:2.2.2:table-6:missing", "report_scope:declaration", "report_scope:external_standard_ranges", "report_scope:inspection_items", "ptr_clause:ptr-2.2.2"], "check_id": "PTR_TABLE", "finding_code": "PTR_TABLE_MISSING", "finding_id": "41847e97-96d8-4371-80c5-66a1a377891c:PTR_TABLE:2.2.2:table-6:missing", "metadata": {"clause_number": "2.2.2", "finding_code": "PTR_TABLE_MISSING", "parameter_name": null, "severity": "error", "source": "ptr_compare_usecase", "table_number": "6"}, "summary": "规则初判 PTR_TABLE_MISSING；check_id=PTR_TABLE；clause=2.2.2；table=6", "target_id": "ptr_review:41847e97-96d8-4371-80c5-66a1a377891c:PTR_TABLE:2.2.2:table-6:missing", "target_type": "ptr_table", "title": "PTR 条款 2.2.2 引用的表 6 未找到。"}

### Target ptr_review:41847e97-96d8-4371-80c5-66a1a377891c:PTR_TABLE:2.6:table-6:missing
{"allowed_evidence_refs": ["finding:41847e97-96d8-4371-80c5-66a1a377891c:PTR_TABLE:2.6:table-6:missing", "rule_context:41847e97-96d8-4371-80c5-66a1a377891c:PTR_TABLE:2.6:table-6:missing", "report_scope:declaration", "report_scope:external_standard_ranges", "report_scope:inspection_items", "ptr_clause:ptr-2.6"], "check_id": "PTR_TABLE", "finding_code": "PTR_TABLE_MISSING", "finding_id": "41847e97-96d8-4371-80c5-66a1a377891c:PTR_TABLE:2.6:table-6:missing", "metadata": {"clause_number": "2.6", "finding_code": "PTR_TABLE_MISSING", "parameter_name": null, "severity": "error", "source": "ptr_compare_usecase", "table_number": "6"}, "summary": "规则初判 PTR_TABLE_MISSING；check_id=PTR_TABLE；clause=2.6；table=6", "target_id": "ptr_review:41847e97-96d8-4371-80c5-66a1a377891c:PTR_TABLE:2.6:table-6:missing", "target_type": "ptr_table", "title": "PTR 条款 2.6 引用的表 6 未找到。"}

### Target ptr_review:41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.3:2.2.3:rise_time:pulse3:unbound
{"allowed_evidence_refs": ["finding:41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.3:2.2.3:rise_time:pulse3:unbound", "rule_context:41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.3:2.2.3:rise_time:pulse3:unbound", "report_scope:declaration", "report_scope:external_standard_ranges", "report_scope:inspection_items", "ptr_clause:ptr-2.2.3", "report_inspection_group:157"], "check_id": "PTR_TABLE", "finding_code": "PTR_ATOMIC_RESULT_UNBOUND", "finding_id": "41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.3:2.2.3:rise_time:pulse3:unbound", "metadata": {"clause_number": "2.2.3", "finding_code": "PTR_ATOMIC_RESULT_UNBOUND", "parameter_name": null, "severity": "warn", "source": "ptr_compare_usecase", "table_number": null}, "summary": "规则初判 PTR_ATOMIC_RESULT_UNBOUND；check_id=PTR_TABLE；clause=2.2.3", "target_id": "ptr_review:41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.3:2.2.3:rise_time:pulse3:unbound", "target_type": "ptr_parameter", "title": "PTR 条款 2.2.3 的参数 脉冲上升时间 未完成报告结果结构化绑定，需要 Codex/人工复核完整检验项证据。报告结果未能稳定抽取，需复核。"}

### Target ptr_review:41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.3:2.2.3:rise_time:pf_reversible:unbound
{"allowed_evidence_refs": ["finding:41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.3:2.2.3:rise_time:pf_reversible:unbound", "rule_context:41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.3:2.2.3:rise_time:pf_reversible:unbound", "report_scope:declaration", "report_scope:external_standard_ranges", "report_scope:inspection_items", "ptr_clause:ptr-2.2.3", "report_inspection_group:157"], "check_id": "PTR_TABLE", "finding_code": "PTR_ATOMIC_RESULT_UNBOUND", "finding_id": "41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.3:2.2.3:rise_time:pf_reversible:unbound", "metadata": {"clause_number": "2.2.3", "finding_code": "PTR_ATOMIC_RESULT_UNBOUND", "parameter_name": null, "severity": "warn", "source": "ptr_compare_usecase", "table_number": null}, "summary": "规则初判 PTR_ATOMIC_RESULT_UNBOUND；check_id=PTR_TABLE；clause=2.2.3", "target_id": "ptr_review:41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.3:2.2.3:rise_time:pf_reversible:unbound", "target_type": "ptr_parameter", "title": "PTR 条款 2.2.3 的参数 脉冲上升时间 未完成报告结果结构化绑定，需要 Codex/人工复核完整检验项证据。报告结果未能稳定抽取，需复核。"}

### Target ptr_review:41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.4:2.2.4:fall_time:unbound
{"allowed_evidence_refs": ["finding:41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.4:2.2.4:fall_time:unbound", "rule_context:41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.4:2.2.4:fall_time:unbound", "report_scope:declaration", "report_scope:external_standard_ranges", "report_scope:inspection_items", "ptr_clause:ptr-2.2.4", "report_inspection_group:157"], "check_id": "PTR_TABLE", "finding_code": "PTR_ATOMIC_RESULT_UNBOUND", "finding_id": "41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.4:2.2.4:fall_time:unbound", "metadata": {"clause_number": "2.2.4", "finding_code": "PTR_ATOMIC_RESULT_UNBOUND", "parameter_name": null, "severity": "warn", "source": "ptr_compare_usecase", "table_number": null}, "summary": "规则初判 PTR_ATOMIC_RESULT_UNBOUND；check_id=PTR_TABLE；clause=2.2.4", "target_id": "ptr_review:41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.4:2.2.4:fall_time:unbound", "target_type": "ptr_parameter", "title": "PTR 条款 2.2.4 的参数 脉冲下降时间 未完成报告结果结构化绑定，需要 Codex/人工复核完整检验项证据。报告结果未能稳定抽取，需复核。"}

## Evidence Items

### Evidence finding:41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.3:2.2.3:rise_time:pf_reversible:unbound
{"file_path": null, "location": "{\"bbox\": null, \"column_name\": null, \"description\": null, \"page_number\": 4, \"row_index\": null, \"section\": \"chapter_2\", \"source_id\": null, \"source_type\": \"ptr\", \"table_id\": null, \"text_span\": null}", "metadata": "{\"check_id\": \"PTR_TABLE\", \"finding_code\": \"PTR_ATOMIC_RESULT_UNBOUND\", \"finding_id\": \"41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.3:2.2.3:rise_time:pf_reversible:unbound\", \"severity\": \"warn\"}", "page_number": 4, "ref_id": "finding:41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.3:2.2.3:rise_time:pf_reversible:unbound", "section": "chapter_2", "source_type": "finding", "structured": "{\"actual\": null, \"check_id\": \"PTR_TABLE\", \"code\": \"PTR_ATOMIC_RESULT_UNBOUND\", \"confidence\": \"medium\", \"diff_fragments\": [], \"evidence\": [{\"confidence\": null, \"id\": \"ptr-atomic-2.2.3:rise_time:pf_reversible\", \"image_ref\": null, \"location\": {\"bbox\": null, \"column_name\": null, \"description\": null, \"page_number\": 4, \"row_index\": null, \"section\": \"chapter_2\", \"source_id\": null, \"source_type\": \"ptr\", \"table_id\": null, \"text_span\": null}, \"metadata\": {}, \"method\": \"pdf_text\", \"normalized_text\": null, \"raw_text\": \"2.2.3 脉冲上升时间\\n脉冲上升时间\\n脉冲上升时间应不超过 700ns。\\natomic=2.2.3:rise_time:pf_reversible; expected=≤700 ns\", \"source_type\": \"ptr\", \"value\": null}, {\"confidence\": null, \"id\": \"report-atomic-2.2.3:rise_time:pf_reversible\", \"image_ref\": null, \"location\": {\"bbox\": null, \"column_name\": null, \"description\": null, \"page_number\": 100, \"row_index\": null, \"section\": null, \"source_id\": null, \"source_type\": \"report\", \"table_id\": null, \"text_span\": null}, \"metadata\": {}, \"method\": \"pdf_text\", \"normalized_text\": null, \"raw_text\": \"157；心脏脉冲\\n电场消融\\n仪；2.2；2.2.1 心脏脉冲电场消融仪输出 \\n心脏脉冲电场消融仪应至少能够提供： \\n电压：3333V（峰值） \\n单位：V\\n𝑝；3375；符合；/；157 心脏脉冲\\n电场消融\\n仪 2.2 2.2.1 心脏脉冲电场消融仪输出 \\n心脏脉冲电场消融仪应至少能够提供： \\n电压：3333V（峰值） \\n单位：V\\n𝑝 3375 符合 /；电流：57A（峰值） \\n单位：A\\n𝑝；59；电流：57A（峰值） \\n单位：A\\n𝑝 59 /；2.2.2 心脏脉冲电场消融仪输出波形图和波形参数 \\n心脏脉冲电场消融仪的输出波形图见图 1，波形参数应满\\n足表 6 的要求。 \\n图 1 是心脏脉冲电场消融仪输出波形图。；2.2.2 心脏脉冲电场消融仪输出波形图和波形参数 \\n心脏脉冲电场消融仪的输出波形图见图 1，波形参数应满\\n足表 6 的要求。 \\n图 1 是心脏脉冲电场消融仪输出波形图。 /；续\\n157；脉冲相\\n间隔；1μsec±20%；-13%～-8%；续\\n157 心脏脉冲\\n电场消融\\n仪 2.2 脉冲相\\n间隔 1μsec±20% -13%～-8% 符合 /；2.2.3 脉冲上升时间 \\n脉冲上升时间应不超过 700ns。 \\n单位：ns；430；PULSE3 预\\n设；2.2.3 脉冲上升时间 \\n脉冲上升时间应不超过 700ns。 \\n单位：ns 430 PULSE3 预\\n设；2.2.5 脉冲衰减 \\n稳定输出后（第一个脉冲组之后），每个脉冲\\n组开始时的电压相比前一组脉冲组结束时电压\\n衰减应在 10%内。；1%；续\\n157 心脏脉冲\\n电场消融\\n仪 2.2 2.2.5 脉冲衰减 \\n稳定输出后（第一个脉冲组之后），每个脉冲\\n组开始时的电压相比前一组脉冲组结束时电压\\n衰减应在 10%内。 1% 符合 /；2.2.6 最大输出能量 \\n单个脉冲最大输出能量应小于 258mJ。 \\n单位：mJ；159；2.2.6 最大输出能量 \\n单个脉冲最大输出能量应小于 258mJ。 \\n单位：mJ 159 /；2.2.7 保护功能 \\n2.2.7.1 温度超限保护 \\n心脏脉冲电场消融仪应具有温度超限报警功能\\n并自动切断脉冲电场能量输出。；符合要求；2.2.7 保护功能 \\n2.2.7.1 温度超限保护 \\n心脏脉冲电场消融仪应具有温度超限报警功能\\n并自动切断脉冲电场能量输出。 符合要求 /；2.2.7.2 过流保护 \\n如果测量的脉冲电场输出电流高于“最大限\\n值”超过 50ms 时，则应生成错误提示。；2.2.7.2 过流保护 \\n如果测量的脉冲电场输出电流高于“最大限\\n值”超过 50ms 时，则应生成错误提示。 符合要求 /\", \"source_type\": \"report\", \"value\": null}], \"expected\": \"≤700 ns\", \"id\": \"41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.3:2.2.3:rise_time:pf_reversible:unbound\", \"location\": {\"bbox\": null, \"column_name\": null, \"description\": null, \"page_number\": 4, \"row_index\": null, \"section\": \"chapter_2\", \"source_id\": null, \"source_type\": \"ptr\", \"table_id\": null, \"text_span\": null}, \"message\": \"PTR 条款 2.2.3 的参数 脉冲上升时间 未完成报告结果结构化绑定，需要 Codex/人工复核完整检验项证据。报告结果未能稳定抽取，需复核。\", \"metadata\": {\"actual\": null, \"atomic_id\": \"2.2.3:rise_time:pf_reversible\", \"atomic_label\": \"脉冲上升时间\", \"candidate_actuals\": [], \"clause_number\": \"2.2.3\", \"codex_required\": true, \"expected\": \"≤700 ns\", \"item_no\": \"157\", \"preset\": \"PF Reversible\", \"report_page\": 100, \"review_hint\": \"请在报告序号 157 的 page 100 行中查找 PULSE3=430 ns、PF Reversible=455 ns。\"}, \"missing_evidence\": [], \"severity\": \"warn\", \"task_id\": \"41847e97-96d8-4371-80c5-66a1a377891c\"}", "text": null, "title": "PTR 条款 2.2.3 的参数 脉冲上升时间 未完成报告结果结构化绑定，需要 Codex/人工复核完整检验项证据。报告结果未能稳定抽取，需复核。"}

### Evidence finding:41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.3:2.2.3:rise_time:pulse3:unbound
{"file_path": null, "location": "{\"bbox\": null, \"column_name\": null, \"description\": null, \"page_number\": 4, \"row_index\": null, \"section\": \"chapter_2\", \"source_id\": null, \"source_type\": \"ptr\", \"table_id\": null, \"text_span\": null}", "metadata": "{\"check_id\": \"PTR_TABLE\", \"finding_code\": \"PTR_ATOMIC_RESULT_UNBOUND\", \"finding_id\": \"41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.3:2.2.3:rise_time:pulse3:unbound\", \"severity\": \"warn\"}", "page_number": 4, "ref_id": "finding:41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.3:2.2.3:rise_time:pulse3:unbound", "section": "chapter_2", "source_type": "finding", "structured": "{\"actual\": null, \"check_id\": \"PTR_TABLE\", \"code\": \"PTR_ATOMIC_RESULT_UNBOUND\", \"confidence\": \"medium\", \"diff_fragments\": [], \"evidence\": [{\"confidence\": null, \"id\": \"ptr-atomic-2.2.3:rise_time:pulse3\", \"image_ref\": null, \"location\": {\"bbox\": null, \"column_name\": null, \"description\": null, \"page_number\": 4, \"row_index\": null, \"section\": \"chapter_2\", \"source_id\": null, \"source_type\": \"ptr\", \"table_id\": null, \"text_span\": null}, \"metadata\": {}, \"method\": \"pdf_text\", \"normalized_text\": null, \"raw_text\": \"2.2.3 脉冲上升时间\\n脉冲上升时间\\n脉冲上升时间应不超过 700ns。\\natomic=2.2.3:rise_time:pulse3; expected=≤700 ns\", \"source_type\": \"ptr\", \"value\": null}, {\"confidence\": null, \"id\": \"report-atomic-2.2.3:rise_time:pulse3\", \"image_ref\": null, \"location\": {\"bbox\": null, \"column_name\": null, \"description\": null, \"page_number\": 100, \"row_index\": null, \"section\": null, \"source_id\": null, \"source_type\": \"report\", \"table_id\": null, \"text_span\": null}, \"metadata\": {}, \"method\": \"pdf_text\", \"normalized_text\": null, \"raw_text\": \"157；心脏脉冲\\n电场消融\\n仪；2.2；2.2.1 心脏脉冲电场消融仪输出 \\n心脏脉冲电场消融仪应至少能够提供： \\n电压：3333V（峰值） \\n单位：V\\n𝑝；3375；符合；/；157 心脏脉冲\\n电场消融\\n仪 2.2 2.2.1 心脏脉冲电场消融仪输出 \\n心脏脉冲电场消融仪应至少能够提供： \\n电压：3333V（峰值） \\n单位：V\\n𝑝 3375 符合 /；电流：57A（峰值） \\n单位：A\\n𝑝；59；电流：57A（峰值） \\n单位：A\\n𝑝 59 /；2.2.2 心脏脉冲电场消融仪输出波形图和波形参数 \\n心脏脉冲电场消融仪的输出波形图见图 1，波形参数应满\\n足表 6 的要求。 \\n图 1 是心脏脉冲电场消融仪输出波形图。；2.2.2 心脏脉冲电场消融仪输出波形图和波形参数 \\n心脏脉冲电场消融仪的输出波形图见图 1，波形参数应满\\n足表 6 的要求。 \\n图 1 是心脏脉冲电场消融仪输出波形图。 /；续\\n157；脉冲相\\n间隔；1μsec±20%；-13%～-8%；续\\n157 心脏脉冲\\n电场消融\\n仪 2.2 脉冲相\\n间隔 1μsec±20% -13%～-8% 符合 /；2.2.3 脉冲上升时间 \\n脉冲上升时间应不超过 700ns。 \\n单位：ns；430；PULSE3 预\\n设；2.2.3 脉冲上升时间 \\n脉冲上升时间应不超过 700ns。 \\n单位：ns 430 PULSE3 预\\n设；2.2.5 脉冲衰减 \\n稳定输出后（第一个脉冲组之后），每个脉冲\\n组开始时的电压相比前一组脉冲组结束时电压\\n衰减应在 10%内。；1%；续\\n157 心脏脉冲\\n电场消融\\n仪 2.2 2.2.5 脉冲衰减 \\n稳定输出后（第一个脉冲组之后），每个脉冲\\n组开始时的电压相比前一组脉冲组结束时电压\\n衰减应在 10%内。 1% 符合 /；2.2.6 最大输出能量 \\n单个脉冲最大输出能量应小于 258mJ。 \\n单位：mJ；159；2.2.6 最大输出能量 \\n单个脉冲最大输出能量应小于 258mJ。 \\n单位：mJ 159 /；2.2.7 保护功能 \\n2.2.7.1 温度超限保护 \\n心脏脉冲电场消融仪应具有温度超限报警功能\\n并自动切断脉冲电场能量输出。；符合要求；2.2.7 保护功能 \\n2.2.7.1 温度超限保护 \\n心脏脉冲电场消融仪应具有温度超限报警功能\\n并自动切断脉冲电场能量输出。 符合要求 /；2.2.7.2 过流保护 \\n如果测量的脉冲电场输出电流高于“最大限\\n值”超过 50ms 时，则应生成错误提示。；2.2.7.2 过流保护 \\n如果测量的脉冲电场输出电流高于“最大限\\n值”超过 50ms 时，则应生成错误提示。 符合要求 /\", \"source_type\": \"report\", \"value\": null}], \"expected\": \"≤700 ns\", \"id\": \"41847e97-96d8-4371-80c5-66a1a377891c:PTR_ATOMIC:2.2.3:2.2.3:rise_time:pulse3:unbound\", \"location\": {\"bbox\": null, \"column_name\": null, \"description\": null, \"page_number\": 4, \"row_index\": null, \"section\": \"chapter_2\", \"source_id\": null, \"source_type\": \"ptr\", \"table_id\": null, \"text_span\": null}, \"message\": \"PTR 条款 2.2.3 的参数 脉冲上升时间 未完成报告结果结构化绑定，需要 Codex/人工复核完整检验项证据。报告结果未能稳定抽取，需复核。\", \"metadata\": {\"actual\": null, \"atomic_id\": \"2.2.3:rise_time:pulse3\", \"atomic_label\": \"脉冲上升时间\", \"candidate_actuals\": [], \"clause_number\": \"2.2.3\", \"codex_required\": true, \"expected\": \"≤700 ns\", \"item_no\": \"157\", \"preset\": \"PULSE3\", \"report_page\": 100, \"review_hint\": \"请在报告序号 157 的 page 100 行中查找 PULSE3=430 ns、PF Reversible=455 ns。\"}, \"missing_evidence\": [], \"severity\": \"warn\", \"task_id\": \"41847e97-96d8-4371-80c5-66a1a377891c\"}", "text": null, "title": "PTR 条款 2.2.3 的参数 脉冲上升时间 未完成报告结果结构化绑定，需要 Codex/人工复核完整检验项证据。报告结果未能稳定抽取，需复核。"}
