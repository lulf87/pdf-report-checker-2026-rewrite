...
- package_id: codex-report-4bef298a-fc56-43da-bb75-17d344ad8515-C03-summary
...
### Target report-codex-check-summary-C03
{"allowed_evidence_refs": ["check_result:C03"], "check_id": "C03", "finding_code": null, "finding_id": null, "metadata": {"source": "report_codex_evidence_builder", "summary_only": true, "target_kind": "check_result_summary"}, "summary": "第三页生产日期指向样品描述栏，C03 跳过", "target_id": "report-codex-check-summary-C03", "target_type": "check_result", "title": "生产日期格式一致性"}

## Evidence Items

### Evidence check_result:C03
{"file_path": null, "location": null, "metadata": "{\"check_id\": \"C03\", \"summary_only\": true, \"target_kind\": \"check_result_summary\"}", "page_number": null, "ref_id": "check_result:C03", "section": "C03", "source_type": "rule_context", "structured": "{\"audit_reason\": \"review deterministic report check summary and decide whether evidence is sufficient\", \"check_id\": \"C03\", \"check_name\": \"生产日期格式一致性\", \"deterministic_finding_count\": 0, \"finding_codes\": [], \"rule_output_role\": \"candidate_summary_not_final_conclusion\", \"status\": \"skip\", \"summary\": \"第三页生产日期指向样品描述栏，C03 跳过\"}", "text": "第三页生产日期与中文标签生产日期格式的规则初判上下文。", "title": "C03 deterministic check summary"}
