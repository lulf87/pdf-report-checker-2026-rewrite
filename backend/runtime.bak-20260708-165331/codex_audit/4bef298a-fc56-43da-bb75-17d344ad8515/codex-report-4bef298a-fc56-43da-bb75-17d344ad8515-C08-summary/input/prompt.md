...
- package_id: codex-report-4bef298a-fc56-43da-bb75-17d344ad8515-C08-summary
...
### Target report-codex-check-summary-C08
{"allowed_evidence_refs": ["check_result:C08"], "check_id": "C08", "finding_code": null, "finding_id": null, "metadata": {"source": "report_codex_evidence_builder", "summary_only": true, "target_kind": "check_result_summary"}, "summary": "检验项目必填字段均非空", "target_id": "report-codex-check-summary-C08", "target_type": "check_result", "title": "检验项目非空字段"}

## Evidence Items

### Evidence check_result:C08
{"file_path": null, "location": null, "metadata": "{\"check_id\": \"C08\", \"summary_only\": true, \"target_kind\": \"check_result_summary\"}", "page_number": null, "ref_id": "check_result:C08", "section": "C08", "source_type": "rule_context", "structured": "{\"audit_reason\": \"review deterministic report check summary and decide whether evidence is sufficient\", \"check_id\": \"C08\", \"check_name\": \"检验项目非空字段\", \"deterministic_finding_count\": 0, \"finding_codes\": [], \"rule_output_role\": \"candidate_summary_not_final_conclusion\", \"status\": \"pass\", \"summary\": \"检验项目必填字段均非空\"}", "text": "报告自检规则初判汇总上下文。", "title": "C08 deterministic check summary"}
