...
- package_id: codex-report-4bef298a-fc56-43da-bb75-17d344ad8515-C01-summary
...
### Target report-codex-check-summary-C01
{"allowed_evidence_refs": ["check_result:C01"], "check_id": "C01", "finding_code": null, "finding_id": null, "metadata": {"source": "report_codex_evidence_builder", "summary_only": true, "target_kind": "check_result_summary"}, "summary": "首页与第三页的委托方、样品名称、型号规格均严格一致", "target_id": "report-codex-check-summary-C01", "target_type": "check_result", "title": "首页与第三页一致性"}

## Evidence Items

### Evidence check_result:C01
{"file_path": null, "location": null, "metadata": "{\"check_id\": \"C01\", \"summary_only\": true, \"target_kind\": \"check_result_summary\"}", "page_number": null, "ref_id": "check_result:C01", "section": "C01", "source_type": "rule_context", "structured": "{\"audit_reason\": \"review deterministic report check summary and decide whether evidence is sufficient\", \"check_id\": \"C01\", \"check_name\": \"首页与第三页一致性\", \"deterministic_finding_count\": 0, \"finding_codes\": [], \"rule_output_role\": \"candidate_summary_not_final_conclusion\", \"status\": \"pass\", \"summary\": \"首页与第三页的委托方、样品名称、型号规格均严格一致\"}", "text": "报告自检规则初判汇总上下文。", "title": "C01 deterministic check summary"}
