...
- package_id: codex-report-4bef298a-fc56-43da-bb75-17d344ad8515-C10-summary
...
### Target report-codex-check-summary-C10
{"allowed_evidence_refs": ["check_result:C10"], "check_id": "C10", "finding_code": null, "finding_id": null, "metadata": {"source": "report_codex_evidence_builder", "summary_only": true, "target_kind": "check_result_summary"}, "summary": "续表标记位置正确", "target_id": "report-codex-check-summary-C10", "target_type": "check_result", "title": "续表标记"}

## Evidence Items

### Evidence check_result:C10
{"file_path": null, "location": null, "metadata": "{\"check_id\": \"C10\", \"summary_only\": true, \"target_kind\": \"check_result_summary\"}", "page_number": null, "ref_id": "check_result:C10", "section": "C10", "source_type": "rule_context", "structured": "{\"audit_reason\": \"review deterministic report check summary and decide whether evidence is sufficient\", \"check_id\": \"C10\", \"check_name\": \"续表标记\", \"deterministic_finding_count\": 0, \"finding_codes\": [], \"rule_output_role\": \"candidate_summary_not_final_conclusion\", \"status\": \"pass\", \"summary\": \"续表标记位置正确\"}", "text": "报告自检规则初判汇总上下文。", "title": "C10 deterministic check summary"}
