...
- package_id: codex-report-e0b64a42-6aa6-4b6c-9c62-ca91fb17b65c-C06-summary
...
### Target report-codex-check-summary-C06
{"allowed_evidence_refs": ["check_result:C06"], "check_id": "C06", "finding_code": null, "finding_id": null, "metadata": {"source": "report_codex_evidence_builder", "summary_only": true, "target_kind": "check_result_summary"}, "summary": "样品描述部件均有对应中文标签", "target_id": "report-codex-check-summary-C06", "target_type": "check_result", "title": "中文标签覆盖"}

## Evidence Items

### Evidence check_result:C06
{"file_path": null, "location": null, "metadata": "{\"check_id\": \"C06\", \"summary_only\": true, \"target_kind\": \"check_result_summary\"}", "page_number": null, "ref_id": "check_result:C06", "section": "C06", "source_type": "rule_context", "structured": "{\"audit_reason\": \"review deterministic report check summary and decide whether evidence is sufficient\", \"check_id\": \"C06\", \"check_name\": \"中文标签覆盖\", \"deterministic_finding_count\": 0, \"finding_codes\": [], \"rule_output_role\": \"candidate_summary_not_final_conclusion\", \"status\": \"pass\", \"summary\": \"样品描述部件均有对应中文标签\"}", "text": "样品描述部件与中文标签 caption/OCR 覆盖关系的规则初判上下文。", "title": "C06 deterministic check summary"}
