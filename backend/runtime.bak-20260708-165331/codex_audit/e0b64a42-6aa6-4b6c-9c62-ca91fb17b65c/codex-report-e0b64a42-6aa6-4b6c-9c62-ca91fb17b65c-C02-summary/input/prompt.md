...
- package_id: codex-report-e0b64a42-6aa6-4b6c-9c62-ca91fb17b65c-C02-summary
...
### Target report-codex-check-summary-C02
{"allowed_evidence_refs": ["check_result:C02"], "check_id": "C02", "finding_code": null, "finding_id": null, "metadata": {"source": "report_codex_evidence_builder", "summary_only": true, "target_kind": "check_result_summary"}, "summary": "第三页型号规格、生产日期、产品编号/批号均指向样品描述栏", "target_id": "report-codex-check-summary-C02", "target_type": "check_result", "title": "第三页扩展字段与中文标签 OCR"}

## Evidence Items

### Evidence check_result:C02
{"file_path": null, "location": null, "metadata": "{\"check_id\": \"C02\", \"summary_only\": true, \"target_kind\": \"check_result_summary\"}", "page_number": null, "ref_id": "check_result:C02", "section": "C02", "source_type": "rule_context", "structured": "{\"audit_reason\": \"review deterministic report check summary and decide whether evidence is sufficient\", \"check_id\": \"C02\", \"check_name\": \"第三页扩展字段与中文标签 OCR\", \"deterministic_finding_count\": 0, \"finding_codes\": [], \"rule_output_role\": \"candidate_summary_not_final_conclusion\", \"status\": \"pass\", \"summary\": \"第三页型号规格、生产日期、产品编号/批号均指向样品描述栏\"}", "text": "第三页扩展字段与中文标签 OCR 字段的规则初判上下文。", "title": "C02 deterministic check summary"}
