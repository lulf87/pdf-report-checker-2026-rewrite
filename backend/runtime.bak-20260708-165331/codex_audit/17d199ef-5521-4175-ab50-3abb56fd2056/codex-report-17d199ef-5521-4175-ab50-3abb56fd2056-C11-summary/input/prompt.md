...
- package_id: codex-report-17d199ef-5521-4175-ab50-3abb56fd2056-C11-summary
...
### Target report-codex-check-summary-C11
{"allowed_evidence_refs": ["check_result:C11"], "check_id": "C11", "finding_code": null, "finding_id": null, "metadata": {"source": "report_codex_evidence_builder", "summary_only": true, "target_kind": "check_result_summary"}, "summary": "报告页码连续且总页数一致", "target_id": "report-codex-check-summary-C11", "target_type": "check_result", "title": "页码连续性"}

## Evidence Items

### Evidence check_result:C11
{"file_path": null, "location": null, "metadata": "{\"check_id\": \"C11\", \"summary_only\": true, \"target_kind\": \"check_result_summary\"}", "page_number": null, "ref_id": "check_result:C11", "section": "C11", "source_type": "rule_context", "structured": "{\"audit_reason\": \"review deterministic report check summary and decide whether evidence is sufficient\", \"check_id\": \"C11\", \"check_name\": \"页码连续性\", \"deterministic_finding_count\": 0, \"finding_codes\": [], \"rule_output_role\": \"candidate_summary_not_final_conclusion\", \"status\": \"pass\", \"summary\": \"报告页码连续且总页数一致\"}", "text": "报告自检规则初判汇总上下文。", "title": "C11 deterministic check summary"}
