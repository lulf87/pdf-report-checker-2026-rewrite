...
- package_id: codex-report-17d199ef-5521-4175-ab50-3abb56fd2056-C05-summary
...
### Target report-codex-check-summary-C05
{"allowed_evidence_refs": ["check_result:C05"], "check_id": "C05", "finding_code": null, "finding_id": null, "metadata": {"source": "report_codex_evidence_builder", "summary_only": true, "target_kind": "check_result_summary"}, "summary": "样品描述部件均有对应照片", "target_id": "report-codex-check-summary-C05", "target_type": "check_result", "title": "照片覆盖"}

## Evidence Items

### Evidence check_result:C05
{"file_path": null, "location": null, "metadata": "{\"check_id\": \"C05\", \"summary_only\": true, \"target_kind\": \"check_result_summary\"}", "page_number": null, "ref_id": "check_result:C05", "section": "C05", "source_type": "rule_context", "structured": "{\"audit_reason\": \"review deterministic report check summary and decide whether evidence is sufficient\", \"check_id\": \"C05\", \"check_name\": \"照片覆盖\", \"deterministic_finding_count\": 0, \"finding_codes\": [], \"rule_output_role\": \"candidate_summary_not_final_conclusion\", \"status\": \"pass\", \"summary\": \"样品描述部件均有对应照片\"}", "text": "样品描述部件与照片 caption 覆盖关系的规则初判上下文。", "title": "C05 deterministic check summary"}
